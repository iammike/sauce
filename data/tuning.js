...
export const TUNING = [
  ...
  },
  {
    ...
    why: 'Two levers, and the carbohydrate is the bigger one — swapping maltodextrin and fructose for sucrose saves more than dropping the flavouring does, though you want both. The salt is the part not to cut: sugar carries none of its own, and whichever level you pick delivers the same sodium per gram of carbohydrate here as it does in the full mix. Expect it to taste like sweet salty water; lemon or lime juice goes in the bottle rather than the jar, so you can add it on the day without committing the batch. It is not free though, and against a mix this cheap it is a large share — the cost panel prices it.',
  },
  {
    id: 'flavor-weak',
