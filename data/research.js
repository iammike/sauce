...
//
// `role` is the card's heading: what this particular source contributes,
...
export const RESEARCH = [
  {
    ...
    name: 'From Metabolism to Medals: Contemporary Perspectives and Revisiting Carbohydrate Guidelines for Fueling Endurance Athletes during Exercise',
    source: 'Morton JP, Fell JM, Gonzalez JT, Hearris MA, Podlogar T, Pugh JN, et al. The Journal of Nutrition, 2026;156(5)',
  ...
  },
  {
    ...
    name: 'A Step Towards Personalized Sports Nutrition: Carbohydrate Intake During Exercise',
    source: 'Jeukendrup A. Sports Medicine, 2014;44(Suppl 1):S25–33',
  ...
  },
  {
    ...
    name: 'Nutrition and Athletic Performance — Joint Position Statement',
    source: 'Thomas DT, Erdman KA, Burke LM. Academy of Nutrition and Dietetics, Dietitians of Canada, and the American College of Sports Medicine. Med Sci Sports Exerc, 2016;48:543–568',
  ...
  },
  {
    ...
    name: 'Carbohydrate and exercise performance: the role of multiple transportable carbohydrates',
    source: 'Jeukendrup A. Curr Opin Clin Nutr Metab Care, 2010',
  ...
  },
  {
    ...
    name: 'New Horizons in Carbohydrate Research and Application for Endurance Athletes',
    source: 'Podlogar T, Wallis GA. Sports Medicine, 2022',
  ...
  },
  {
    ...
    source: 'Journal of Sports Sciences (Taylor & Francis), 2019',
